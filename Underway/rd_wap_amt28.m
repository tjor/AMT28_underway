...
function [pctime, acs, bb3_old, flow, cstar, ctd, ac9] = rd_wap_amt28(flowdir, filename, fileext)
   ...
   if dddHHH==270+11/24 % this is for the hour when I swapped ac9 and cstar
        
        if strfind(filename, 'ac9')
            cstarname = [];
            ac9name = '_23_AC9';        
        endif
        
   elseif dddHHH<270+11/24  % this is when at the start of the cruise I ran the AC9
        cstarname = [];
        ac9name = '_23_AC9';
   
   endif
   
   if dddHHH<292+7/24 % this is for when the acs was working
        acsname = '_21_ACS';
...
%          endif
   ...
   elseif dddHHH>=292+7/24  % this is for when the acs was NOT working and was swapped with the ac9
        ac9name = '_21_AC9';
        acsname = [];
